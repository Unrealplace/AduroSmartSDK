...
#define YXMFTPANONYMOUS @"anonymous"
/*enum {
...
@interface YXMFMServer : NSObject {
@private
...
@interface NSString (YXMFTPManagerNSStringAdditions)
...
@protocol YXMFTPManagerDelegate <NSObject>
@optional
...
@interface YXMFTPManager : NSObject <NSStreamDelegate> {
...
@property (assign) id<YXMFTPManagerDelegate>delegate;
 ...
 */
- (BOOL) deleteFile:(NSString *)absolutePath fromServer:(YXMFMServer *)server DEPRECATED_ATTRIBUTE;
