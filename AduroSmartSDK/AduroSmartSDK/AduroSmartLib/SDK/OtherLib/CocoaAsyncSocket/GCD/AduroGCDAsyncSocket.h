...
@class AduroGCDAsyncReadPacket;
@class AduroGCDAsyncWritePacket;
@class AduroGCDAsyncSocketPreBuffer;
...
extern NSString *const AduroGCDAsyncSocketException;
extern NSString *const AduroGCDAsyncSocketErrorDomain;

extern NSString *const AduroGCDAsyncSocketQueueName;
extern NSString *const AduroGCDAsyncSocketThreadName;

#if SECURE_TRANSPORT_MAYBE_AVAILABLE
extern NSString *const AduroGCDAsyncSocketSSLCipherSuites;
#if TARGET_OS_IPHONE
extern NSString *const AduroGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const AduroGCDAsyncSocketSSLProtocolVersionMax;
#else
extern NSString *const AduroGCDAsyncSocketSSLDiffieHellmanParameters;
#endif
#endif
...
@interface AduroGCDAsyncSocket : NSObject
...
**/
- (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(AduroGCDAsyncSocket *)sock;
...
**/
- (void)socket:(AduroGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
 ...
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(AduroGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(AduroGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(AduroGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(AduroGCDAsyncSocket *)sock;
...
**/
- (void)socketDidSecure:(AduroGCDAsyncSocket *)sock;
