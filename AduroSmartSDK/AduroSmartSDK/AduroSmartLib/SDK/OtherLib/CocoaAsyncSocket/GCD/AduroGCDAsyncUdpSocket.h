...
extern NSString *const AduroGCDAsyncUdpSocketException;
extern NSString *const AduroGCDAsyncUdpSocketErrorDomain;

extern NSString *const AduroGCDAsyncUdpSocketQueueName;
extern NSString *const AduroGCDAsyncUdpSocketThreadName;
...
@interface AduroGCDAsyncUdpSocket : NSObject
...
**/
- (void)udpSocket:(AduroGCDAsyncUdpSocket *)sock didNotConnect:(NSError *)error;
...
**/
- (void)udpSocketDidClose:(AduroGCDAsyncUdpSocket *)sock withError:(NSError *)error;
