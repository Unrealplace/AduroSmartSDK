...
@class AduroAsyncSendPacket;
@class AduroAsyncReceivePacket;

extern NSString *const AduroAsyncUdpSocketException;
extern NSString *const AduroAsyncUdpSocketErrorDomain;
...
@interface AduroAsyncUdpSocket : NSObject
{
	...
	AduroAsyncSendPacket *theCurrentSend;
	NSTimer *theSendTimer;
	
	NSMutableArray *theReceiveQueue;
	AduroAsyncReceivePacket *theCurrentReceive;
...
**/
- (void)onUdpSocket:(AduroAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)onUdpSocket:(AduroAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError *)error;
...
**/
- (BOOL)onUdpSocket:(AduroAsyncUdpSocket *)sock
...
**/
- (void)onUdpSocket:(AduroAsyncUdpSocket *)sock didNotReceiveDataWithTag:(long)tag dueToError:(NSError *)error;

/**
 * Called when the socket is closed.
 * A socket is only closed if you explicitly call one of the close methods.
**/
- (void)onUdpSocketDidClose:(AduroAsyncUdpSocket *)sock;
