...
#define GAduroLocalConnection [AduroLocalConnection sharedInstance]

/// We post self to this notification,
/// then you should invoke currentLocalConnectionStatus method to fetch current status.
extern NSString *const kAduroLocalConnectionChangedNotification;
...
extern NSString *const kAduroLocalConnectionInitializedNotification;
...
@interface AduroLocalConnection : NSObject
