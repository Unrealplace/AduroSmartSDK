...
NSString *const kAduroLocalConnectionInitializedNotification = @"kLocalConnectionInitializedNotification";
NSString *const kAduroLocalConnectionChangedNotification = @"kLocalConnectionChangedNotification";

@interface AduroLocalConnection ()
...
#pragma unused (target)
    AduroLocalConnection *connection = ((__bridge AduroLocalConnection*)info);
...
@implementation AduroLocalConnection
...
- (void)startNotifier
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:kAduroLocalConnectionInitializedNotification
                                                            object:strongSelf];
    });
}
...
- (void)localConnectionChanged
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        __strong __typeof(weakSelf)strongSelf = weakSelf;
        [[NSNotificationCenter defaultCenter] postNotificationName:kAduroLocalConnectionChangedNotification
                                                            object:strongSelf];
    });
}
