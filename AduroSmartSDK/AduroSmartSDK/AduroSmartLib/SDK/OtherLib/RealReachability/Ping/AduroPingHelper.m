...
NSString *const kAduroPingResultNotification = @"kPingResultNotification";

@interface AduroPingHelper() <AduroPingFoundationDelegate>

@property (nonatomic, strong) NSMutableArray *completionBlocks;
@property(nonatomic, strong) AduroPingFoundation *pingFoundation;
@property (nonatomic, assign) BOOL isPinging;

@end

@implementation AduroPingHelper
...
- (void)startPing
{
    ...
    self.pingFoundation = [[AduroPingFoundation alloc] initWithHostName:self.host];
...
- (void)setHost:(NSString *)host
{
    ...
    self.pingFoundation = [[AduroPingFoundation alloc] initWithHostName:_host];
...
- (void)endWithFlag:(BOOL)isSuccess
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        [[NSNotificationCenter defaultCenter] postNotificationName:kAduroPingResultNotification
